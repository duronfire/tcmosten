# Generated by Django 3.1.1 on 2020-12-30 20:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start', models.DateTimeField(default=datetime.datetime(2020, 12, 30, 20, 36, 53, 41732))),
                ('end', models.DateTimeField(default=datetime.datetime(2020, 12, 30, 20, 36, 53, 41732))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billstate', models.CharField(choices=[('nobill', 'nobill'), ('billed', 'billed')], max_length=10)),
                ...
                ('LastModified', models.DateTimeField(auto_now=True)),
                ('synclabel', models.CharField(choices=[('toupdate', 'toupdate'), ('sync', 'sync')], default='toupdate', max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Sollkonto',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Creation', models.DateTimeField(auto_now_add=True)),
                ('LastModified', models.DateTimeField(auto_now=True)),
                ('mahnungen', models.ManyToManyField(to='isys.Mahnung')),
                ('meetings', models.ManyToManyField(to='isys.Meeting')),
        ...
        migrations.AddField(
            model_name='meeting',
            name='methods',
            field=models.ManyToManyField(to='isys.Method'),
        ),
        migrations.AddField(
            model_name='meeting',
            name='patient',
        ...
        migrations.AddField(
            model_name='meeting',
            name='uploadfiles',
            field=models.ManyToManyField(to='isys.Uploadfilepath'),
        ),
        migrations.CreateModel(
            name='Buchung',
            fields=[
